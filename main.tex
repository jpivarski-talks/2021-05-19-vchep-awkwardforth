...
\vspace{0.1 cm}
\uncover<3->{JIT-compile the deserialization code.}

\vspace{\baselineskip}
\vspace{0.1 cm}
\uncover<4->{Use a parser combinator library.}

\vspace{\baselineskip}
\vspace{0.1 cm}
\uncover<5->{Create a lightweight/specialized virtual machine.}
...
\vspace{0.1 cm}
\uncover<3->{Adding LLVM as a dependency would undermine portability.}

\vspace{0.1 cm}
\uncover<4->{ROOT deserialization requires advanced language features.}

\vspace{0.1 cm}
\uncover<5->{That's the subject of this talk.}
\end{columns}
\end{frame}
